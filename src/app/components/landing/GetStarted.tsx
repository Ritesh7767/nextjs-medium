  ...
  return (
    <section className='absolute top-0 left-0 right-0 bottom-0 bg-white/90'>
        <div className="absolute top-0 bottom-0 left-0 right-0 sm:left-28 sm:right-28 bg-white shadow-2xl">
          ...
          <p className='text-center mt-10'>Already have an account? <span onClick={() => setSignUp(!signUp)} className='font-bold text-green-700 cursor-pointer'>Sign {signUp ? "in": "up"}</span></p>
